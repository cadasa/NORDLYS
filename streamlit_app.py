...
#        hover = alt.selection_single(on='mouseover')
        ...
        c1a = base.mark_area(align='left').encode(
            ...
            width=585, height=340
        ).interactive()

        c1b = alt.Chart(prod_year_sum).mark_point(size=35,clip=False,align='left',color='black',strokeWidth=2,shape='triangle-down',yOffset=-3).encode(
